...
class TermsAndCondtionsScreen extends StatefulWidget {
  const TermsAndCondtionsScreen({Key? key}) : super(key: key);

  @override
  State<TermsAndCondtionsScreen> createState() =>
      _TermsAndCondtionsScreenState();
}

class _TermsAndCondtionsScreenState extends State<TermsAndCondtionsScreen> {
  Widget _textWidget(
