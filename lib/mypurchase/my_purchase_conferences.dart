...
class MyPurchaseConferences extends StatefulWidget {
  const MyPurchaseConferences({Key? key}) : super(key: key);

  @override
  State<MyPurchaseConferences> createState() => _MyPurchaseConferencesState();
}

bool upcomingSelected = true;
bool pastSelected = false;

class _MyPurchaseConferencesState extends State<MyPurchaseConferences> {
