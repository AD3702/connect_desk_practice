...
class MyPurchaseSessions extends StatefulWidget {
  const MyPurchaseSessions({Key? key}) : super(key: key);

  @override
  State<MyPurchaseSessions> createState() => _MyPurchaseSessionsState();
}

bool upcomingSelected = true;
bool pastSelected = false;

class _MyPurchaseSessionsState extends State<MyPurchaseSessions> {
