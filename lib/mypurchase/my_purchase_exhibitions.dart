...
class MyPurchaseExhibitions extends StatefulWidget {
  const MyPurchaseExhibitions({Key? key}) : super(key: key);

  @override
  State<MyPurchaseExhibitions> createState() => _MyPurchaseExhibitionsState();
}

bool upcomingSelected = true;
bool pastSelected = false;

class _MyPurchaseExhibitionsState extends State<MyPurchaseExhibitions> {
